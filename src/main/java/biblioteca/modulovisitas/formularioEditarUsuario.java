...
public class formularioEditarUsuario extends CustomComponent {
	...
	@AutoGenerated
	private Label labelErrorExistente;

	@AutoGenerated
	private Label labelErrorDistinto;
	...
	public formularioEditarUsuario(MyUI main, String cedula, String carne, String nombre, String apellidos, String email, String telefono, String institucion, String tipo) 
	{
		...
		labelErrorExistente.setVisible(false);
		...
		botonGuardar.addClickListener(new ClickListener(){
			...
			public void buttonClick(ClickEvent event) {
				...
				if(noError){
					...
					clave1 = textFieldClave1.getValue();
					clave2 = textFieldClave1.getValue();
					
					if(clave1.equals(clave2))
					{
						ResultSet rs = dbc.query("SELECT 1 FROM Usuario WHERE clave='"+clave1+"'");
						try{
							...
							{
								labelErrorDistinto.setVisible(false);
								labelErrorExistente.setVisible(true);
					...
					{
						labelErrorDistinto.setVisible(true);
						labelErrorExistente.setVisible(false);
						System.out.println("Las claves introducidas no coinciden.");
					}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(labelClave2, "top:380.0px;left:5.0px;");
		
		// labelErrorDistinto
		labelErrorDistinto = new Label();
		labelErrorDistinto.setImmediate(false);
		labelErrorDistinto.setWidth("-1px");
		labelErrorDistinto.setHeight("-1px");
		labelErrorDistinto.setValue("Las contraseñas introducidas no coinciden.");
		mainLayout.addComponent(labelErrorDistinto, "top:420.0px;left:241.0px;");
		
		// labelErrorExistente
		labelErrorExistente = new Label();
		labelErrorExistente.setImmediate(false);
		labelErrorExistente.setWidth("-1px");
		labelErrorExistente.setHeight("-1px");
		labelErrorExistente.setValue("La contraseña introducida ya está tomada.");
		mainLayout.addComponent(labelErrorExistente, "top:420.0px;left:241.0px;");
