...
public class formularioNuevaConsulta extends CustomComponent {
	...
	public formularioNuevaConsulta() 
	{
		...
		inputCedula.addValueChangeListener(new ValueChangeListener()
		{
			@Override 
			 public void valueChange(ValueChangeEvent vcEvent)
			 {
				String cedula = inputCedula.getValue();
				String carne;
				String apellidos;
				String nombre;
				String email;
				...
				try{
					...
					{
						rs2 = dbc.query("SELECT u.cedula, u.carne, u.apellidos, u.nombre, u.email, u.institucion, u.tipo, t.numero FROM usuario u, telefono t "
								+ "WHERE u.cedula = '"+ cedula +"' AND t.cedula = u.cedula");
						
						if(rs2.next())
						{	
							carne = rs2.getString("carne");
							apellidos = rs2.getString("apellidos");
							nombre = rs2.getString("nombre");
							email = rs2.getString("email");
							institucion = rs2.getString("institucion");
							tipo = rs2.getString("tipo");
							telefono = rs2.getString("numero");
							if(carne != null)
							{
