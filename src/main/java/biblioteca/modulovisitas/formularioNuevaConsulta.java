...
public class formularioNuevaConsulta extends CustomComponent {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(labelTipoConsulta, "top:517.0px;left:292.0px;");
		...
		mainLayout.addComponent(inputTipoConsulta, "top:517.0px;left:419.0px;");
		...
		inputObservaciones.setWidth("443px");
		inputObservaciones.setHeight("29px");
		mainLayout.addComponent(inputObservaciones, "top:437.0px;left:124.0px;");
		...
		inputTema.setWidth("443px");
		inputTema.setHeight("30px");
		mainLayout.addComponent(inputTema, "top:290.0px;right:167.0px;");
		
		// button_reporte
		button_reporte = new Button();
		button_reporte.setCaption("Generar Reporte");
