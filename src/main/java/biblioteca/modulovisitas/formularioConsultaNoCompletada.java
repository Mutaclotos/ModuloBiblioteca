...
public class formularioConsultaNoCompletada extends CustomComponent
{
	...
	public formularioConsultaNoCompletada()
	{
		...
		ResultSet rs = dbc.query("SELECT u.nombre, u.apellidos, u.cedula, u.carne, u.email, u.institucion, u.tipo as tipoUsuario,"
				+ " c.tema, c.tipo, c.fechaEmision, c.observaciones FROM consulta c, usuario u WHERE c.usuario = u.cedula ");
		try{
			while(rs.next())
			{
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(labelTitulo, "top:0.0px;left:307.0px;");
		...
		mainLayout.addComponent(button_volver, "top:395.0px;left:600.0px;");
		...
		button_verCompletadas.setWidth("212px");
		button_verCompletadas.setHeight("-1px");
		mainLayout.addComponent(button_verCompletadas, "top:395.0px;left:368.0px;");
		
		// inputTipoBusqueda
		inputTipoBusqueda = new ComboBox();
		inputTipoBusqueda.setImmediate(false);
		inputTipoBusqueda.setWidth("141px");
		inputTipoBusqueda.setHeight("-1px");
		mainLayout.addComponent(inputTipoBusqueda, "top:60.0px;left:40.0px;");
		
		// inputBusqueda
		inputBusqueda = new TextField();
		inputBusqueda.setImmediate(false);
		inputBusqueda.setWidth("280px");
		inputBusqueda.setHeight("-1px");
		inputBusqueda.setInputPrompt("Buscar...");
		mainLayout.addComponent(inputBusqueda, "top:60.0px;left:220.0px;");
