	...
	String cedula, String nombre, String apellidos, String telefono, String fechaSolicitud, String fechaCaducidad, String estado) 
	{
		...
		botonGuardar.addClickListener(new ClickListener()
		{
			...
			public void buttonClick(ClickEvent event)
			{
				...
				if(inputFechaCaducidad.isValid() && inputTipoPrestamo.isValid() && (checkBoxACEPTAR.getValue() || checkBoxRECHAZAR.getValue()))
				{
					//TODO: fix updates
					try{
						if(checkBoxACEPTAR.getValue() && !checkBoxRECHAZAR.getValue())
						{
							...
							if(!checkBoxDEVUELTO.getValue())
							{
								estado = "PRESTADO";
								
								dbc.update("Prestamo", "estado='"+estado+"', fechaEntrega='"+fechaEntrega+"', fechaCaducidad='"+fechaCaducidad+"', tipo='"+tipoPrestamo+"'","id='"+IDSolicitud+"'");
							}
							else
							{
								estado = "DEVUELTO";
						...
						else if(checkBoxRECHAZAR.getValue() && !checkBoxACEPTAR.getValue())
						{
							...
							dbc.update("Prestamo", "estado='"+estado+"'","id='"+IDSolicitud+"'");						
						}
