...
public class formularioentrada extends CustomComponent {
		...
		botonGuardar.addClickListener(new ClickListener(){
			...
			public void buttonClick(ClickEvent event) {
				...
				if(noError){
					...
					hEntrada = inputHEntrada.getValue();
					hSalida = inputHSalida.getValue();
					institucion = inputInstitucion.getValue();
					nombre = inputNombre.getValue();
					tipo = inputSoy.getValue().toString();
					tema = inputTema.getValue();
					System.out.println("SELECT 1 FROM Usuarios WHERE cedula='"+cedula+"'");
					System.out.println("INSERT INTO Usuarios(cedula,carne,apellidos,nombre,email,institucion,tipo) VALUES "
							+ "('"+cedula+"', '"+carne+"', '"+apellidos+"', '"+nombre+"', '"+email+"', '"+institucion+"', '"+tipo+"');");
					System.out.println("INSERT INTO Visita(tema,horaLlegada,horaSalida,usuario) VALUES('"+tema+"', '"+hEntrada+"', '"+hSalida+"', '"+cedula+"');");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(botonGuardar, "top:380.0px;left:256.0px;");
		...
		mainLayout.addComponent(labelHoraSalida, "top:342.0px;left:436.0px;");
		...
		mainLayout.addComponent(inputHSalida, "top:340.0px;left:540.0px;");
		...
		mainLayout.addComponent(inputHEntrada, "top:340.0px;left:120.0px;");
		...
		mainLayout.addComponent(labelHoraEntrada, "top:342.0px;left:7.0px;");
