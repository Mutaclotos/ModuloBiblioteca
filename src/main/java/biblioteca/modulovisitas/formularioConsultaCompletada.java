...
public class formularioConsultaCompletada extends CustomComponent
{
	...
	public formularioConsultaCompletada()
	{
		...
		button_grafico.addClickListener(new ClickListener()
		{
			private static final long serialVersionUID = 47254532L;
			@Override
			public void buttonClick(ClickEvent event)
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(button_verPendientes, "top:395.0px;left:320.0px;");
		...
		// button_grafico
		button_grafico = new Button();
		button_grafico.setCaption("VER GRAFICOS");
		button_grafico.setImmediate(true);
		button_grafico.setWidth("200px");
		button_grafico.setHeight("40px");
		mainLayout.addComponent(button_grafico, "top:395.0px;left:693.0px;");
